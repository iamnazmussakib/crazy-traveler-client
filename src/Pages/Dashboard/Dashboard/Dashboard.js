...
function Dashboard(props) {
    ...
    const drawer = (
        <div>
            <Toolbar />
            <Divider />
            <Link to={`/dashboard/manage-article`}><Button sx={{ width: '100%', my: 1 }} color="primary" variant="outlined">Manage All Article</Button></Link>
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            >
                <Toolbar style={{ backgroundColor: '#005a9c' }}>
                    <IconButton
                        color="inherit"
